	...
	const jobs = [
		{
			...
			location: "USA",
			description: <ul>
            <li>Designing and developing software applications using a variety of programming languages, frameworks and databases</li>
            <li>Building and maintaining the front-end and back-end aspects of web and mobile applications</li>
		...
		},
        {
            ...
            <li>Conducting AML risk assessments to identify and mitigate potential money laundering risks</li>
            <li>Monitoring transactions for suspicious activity and filing suspicious activity reports (SARs) when necessary</li>
            <li>Participating in AML investigations and providing support to law enforcement agencies as needed</li>
            </ul>,
		},

        {
			...
			location: "Malta",
			description: <ul>
            <li>Coordinating and overseeing the processing of transactions, such as deposits and withdrawals</li>
            <li>Managing the bank's relationships with vendors and service providers</li>
            <li>Developing and implementing operational procedures and policies</li>
            <li>Troubleshooting and resolving operational issues as they arise</li>
            </ul>,
		},
        {
			...
			description: <ul>
            <li>Monitoring and evaluating team performance and providing feedback and coaching</li>
            <li>Handling escalations and resolving complex customer issues</li>
            <li>Developing and implementing customer service policies and procedures</li>
